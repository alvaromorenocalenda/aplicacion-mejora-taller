...
export default function AgendaMecanicosPage() {
  ...
  async function cambiarEstado(id, estado) { if (estado === "terminado") mostrarAviso("ok", "Trabajo terminado", "Trabajo marcado como terminado."); await updateDoc(doc(db, "agenda_mecanicos", id), { estado, actualizadoEn:serverTimestamp() }); await cargarDatos() }
